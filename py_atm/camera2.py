...
def signal_handler(signal, frame):
    ...
    for img in images:
        ...
        #cv2.waitKey(10)
        cv2.imwrite("images/camera_2_" + str(count) + ".jpg", img_)
...
with Vimba() as vimba:
    ...
    camera0 = vimba.getCamera(cameraIds[1]) #-------------------- ID de la camara
    camera0.openCamera()
    ...
    while getImages:
        ...
        if success:
            ...
            if option == "1":
                ...
                cv2.imwrite("images/calib_cam2_" + str(count) + ".jpg", rgb)
